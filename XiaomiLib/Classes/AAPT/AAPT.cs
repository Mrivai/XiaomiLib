...
namespace Mrivai.Pelitabangsa
{
    ...
    public partial class AAPT : IDisposable
    {
        ...
        public AAPT()
        {
            ...
            resDir = ResourceFolderManager.GetRegisteredFolderPath("AAPT");
        ...
        public Badging DumpBadging(FileInfo source)
        {
            ...
            return new Badging(source, Command.RunProcessReturnOutput(Path.Combine(resDir, "aapt.exe"), "dump badging \"" + source.FullName + "\"", true, Command.DEFAULT_TIMEOUT));
        }
        ...
        private void ExtractResources(string path)
        {
            ...
            Extract.Resources("Mrivai.Pelitabangsa", path, "Resources.AAPT", res);
        }
