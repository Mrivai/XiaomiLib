...
namespace Mrivai.Pelitabangsa
{
    ...
    public class FastbootCommand
    {
        ...
        internal FastbootCommand(string command) { this.command = command; timeout = Mrivai.Command.DEFAULT_TIMEOUT; }
    ...
    public static class Fastboot
    {
        ...
        {
            return Command.RunProcessReturnOutput(XiaomiController.Instance.ResourceDirectory + FASTBOOT_EXE, command.Command, command.Timeout);
        }
        ...
        {
            Command.RunProcessNoReturn(XiaomiController.Instance.ResourceDirectory + FASTBOOT_EXE, command.Command, command.Timeout);
        }

        internal static void EDL()
        {
            Command.RunProcessNoReturn(XiaomiController.Instance.ResourceDirectory + EDL_EXE, "reboot-edl", -1);
        }
    }
}
